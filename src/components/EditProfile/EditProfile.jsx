  ...
  return (
    ...
    <main className='edit'>
      ...
      <form className='edit__form' action="submit">
        ...
        <section className='edit__profile'>
          ...
          <div className='edit__profile--text'>
            ...
            <input className='edit__input edit__input--username' type="text" name="username" id="username" placeholder='USERNAME'/>
      ...
      <h2 className='edit__heading'>ADD NEW PROMO</h2>
            ...
            <textarea className='edit__textarea' type="text" rows="10" />
